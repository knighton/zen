...
from zen.dataset.clevr import load_clevr_cogent_same, load_clevr_main
...
def run(args):
    ...
    answer_pipe = Pipe(OneHot)
    size = parse_size(args.size)
    data = load_clevr_cogent_same(question_pipe, answer_pipe, args.storage,
